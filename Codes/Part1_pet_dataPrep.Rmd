...
png("../EPIB607Notes2012/Part1Figs/box_horizontal.png", width = 1000, height = 500, units = "px",  res = 150)
    boxplot(petSurvey$SRHealth, main = "Boxplot - Self-asessed helath", xlab = "Self-asessed health")
dev.off()
...
par(mfrow = c(1, 3))
  sales <- (rbeta(10000,2,5)*200)
  hist(sales, main = "Annual income in 1000 CAD
       from 10000 households")
  hist(log(sales), main = "Annual income in 1000 CADk, LN")
  hist(sqrt(sales), main = "Annual income in 1000 CAD, sqrt")
dev.off()
