...
hist(x, freq = FALSE, 
        main = "Density plot and hisrogram for small sample, birth weight (n=50 subjects)", 
        xlab = "weight in Kg", 
        breaks = 10)
...
png("../EPIB607Notes2012/Part1Figs/densityWgt.png", width = 1000, height = 500, units = "px",  res = 150)
  x <- rnorm(mean = 3.8, sd = 0.5, n = 300) %>% round(2)
   hist(x, freq = FALSE, 
        main = "Hypothetical birth weight of girls, n=300 subjects", 
        xlab = "weight in Kg", 
        breaks = 10)
  # Add density
  lines(density(x), lwd = 2, col = "red")
...
x <- rnorm(mean = 3.8, sd = 0.5, n = 30) %>% round(2)
hist(x, main = "birthweight of babies in kg, small sample (n=30", freq = F, ylim = c(0,1))
